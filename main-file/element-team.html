      ...
      <div class="row">
         <div class="col-sm-12">
            <div class="page-titles text-center">
               <h2 class="whitecolor font-light bottom30">Our Team</h2>
      ...
      <div class="row">
         <div class="col-lg-3 col-md-3">
            <div class="team-box grey-shade top60">
               <div class="image">
                  <img src="images/team-grey-1.jpg" alt="">
               </div>
         ...
         <div class="col-lg-3 col-md-3">
            <div class="team-box grey-shade top60">
               <div class="image">
                  <img src="images/team-grey-2.jpg" alt="">
               </div>
               <div class="team-content darkcolor">
                  <h3>Johny Walkin.</h3>
         ...
         <div class="col-lg-3 col-md-3">
            <div class="team-box grey-shade top60">
               <div class="image">
                  <img src="images/team-grey-3.jpg" alt="">
               </div>
               <div class="team-content darkcolor">
                  <h3>Teena Walkin</h3>
         ...
         <div class="col-lg-3 col-md-3">
            <div class="team-box grey-shade top60">
               <div class="image">
                  <img src="images/team-grey-4.jpg" alt="">
               </div>
               <div class="team-content darkcolor">
                  <h3>Teena Walkin</h3>
                  <p class="nomargin">Model, The XeOne Company</p>
...
<!-- Our Team-->    
<section id="our-team-three" class="padding bglight">
   <div class="container">
      <div class="row">
         <div class="col-md-8 offset-md-2 col-sm-12 text-center">
            <div class="heading-title">
...
<!-- Our Team ends-->                                                                                                                                                                                                                                                           <!-- Our Team-->    
<section id="our-team-four" class="padding bglight">
   <div class="container">
      <div class="row">
         <div class="col-md-8 offset-md-2 col-sm-12 text-center">
            <div class="heading-title">
